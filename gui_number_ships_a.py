'''
Handles Selection of Ships for easy-level AI.
...
from gui_shiplocations_a import aShipPlacementView
...
class aNumberShips(arcade.View):
    '''
    ...
    def __init__(self):
        ...
        :pre: The MainMenu class has been run and the user pressed the play_button/  easy-level AI __init__
    ...
    def number_1(self):
        ...
        place_ships_view = aShipPlacementView(player1)
