    ...
    def on_mouse_press(self, x, y, button, modifiers):
        ...
        if row < ROW_COUNT and column < COLUMN_COUNT:
            ...
            # allows selection of location of ship to be vertical
                ...
                for k in range(self.length_of_ship):
                    if  row < ROW_COUNT and column < COLUMN_COUNT and (
                            column + self.length_of_ship - 1) < COLUMN_COUNT and self.grid[row - k][column] == 1:
                        bol2 = False
                        bol = False
                        break
                    else:
                ...
                if self.grid[row][column] == 0 and not self.selected:
                    for i in range(self.length_of_ship):
                        if row < ROW_COUNT and column < COLUMN_COUNT and (row - self.length_of_ship + 1) > -1 and bol2 == True and bol == True:
    ...
    def place(self):
        ...
        if row < ROW_COUNT and column < COLUMN_COUNT:
            ...
            # allows selection of location of ship to be vertical
                ...
                if self.grid[row][column] == 0 and not self.selected:
                    for i in range(self.length_of_ship):
                        if row < ROW_COUNT and column < COLUMN_COUNT and (row - self.length_of_ship + 1) > -1 and bol == True:
                            self.grid[row - i][column] = 1
                            self.selected = True
                        else:
                            self.grid[row][column] = 0
